...
<script src="https://unpkg.com/htmx-select@latest"
        integrity="sha384-Jipyz7VFsYoNax8N4SZyU2yLO37a8sd9FEowjWMHKXzqOLMNGc9NdGnx6e3YR7LQ"
...
When selecting a specific version (i.e. 0.0.0 or 0.0.1), this extension will make a HTTP GET request based on the `value` of the option selected. This is made possible via the `hx-get` attribute and ensuring each option element has a URI value. That's it!
